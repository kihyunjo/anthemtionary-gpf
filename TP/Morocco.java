...
public class Morocco extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Morocco");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Morocco: النشيد الوطني المغربي");
	private	java.net.URL flagPath = getClass().getResource("morocco.jpeg");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("morocco_arabic.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("morocco_english.png");	
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Morocco.wav"));
