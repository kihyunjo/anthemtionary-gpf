...
public class Indonesia extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Indonesia");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Indonesia: Indonesia Raya");
	private	java.net.URL flagPath = getClass().getResource("indonesia.gif");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("indonesia_indonesian.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("indonesia_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Indonesian", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Indonesia.wav"));
	...
	{
		Indonesia mainGui = new Indonesia();
