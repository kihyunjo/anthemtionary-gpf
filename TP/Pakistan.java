...
public class Pakistan extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Pakistan");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Pakistan: قومی ترانہ");
	private JLabel flagLabel = new JLabel(new ImageIcon("pakistan.png"));
	private JLabel firstLyrics = new JLabel(new ImageIcon("pakistan_urdu.png"));
	private JLabel secondLyrics = new JLabel(new ImageIcon("pakistan_english.png"));
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Urdu", TitledBorder.CENTER,
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Pakistan.wav"));
