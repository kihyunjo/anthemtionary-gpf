...
public class Greece extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Greece");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Greece: Ύμνος εις την ελευθερίαν");
	private	java.net.URL flagPath = getClass().getResource("greece.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("greece_greek.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("greece_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Greek", TitledBorder.CENTER,
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Greece.wav"));
