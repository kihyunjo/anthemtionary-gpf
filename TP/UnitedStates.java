...
public class UnitedStates extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("United States");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("United States: The Star-Spangled Banner");
	private	java.net.URL flagPath = getClass().getResource("unitedstates.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("unitedstates_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "English", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("UnitedStates.wav"));
	...
	{
		UnitedStates mainGui = new UnitedStates();
