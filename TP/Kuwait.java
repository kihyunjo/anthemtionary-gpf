...
public class Kuwait extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Kuwait");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Kuwait: النشيد الوطني");
	private	java.net.URL flagPath = getClass().getResource("kuwait.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("kuwait_english.png");	
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Kuwait.wav"));
