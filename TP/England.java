...
public class England extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("England");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("England: God Save the Queen");
	private	java.net.URL flagPath = getClass().getResource("england.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("england_english.png");	
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("England.wav"));
