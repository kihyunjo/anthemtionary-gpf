...
public class Netherlands extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Netherlands");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Netherlands: Wilhelmus");
	private	java.net.URL flagPath = getClass().getResource("netherlands.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("netherlands_dutch.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("netherlands_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Dutch", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Netherlands.wav"));
	...
	{
		Netherlands mainGui = new Netherlands();
