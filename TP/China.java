...
public class China extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("China");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("China: 义勇军进行曲");
	private	java.net.URL flagPath = getClass().getResource("china.jpg");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("china_chinese.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("china_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Chinese", TitledBorder.CENTER,
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("China.wav"));
