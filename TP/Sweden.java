...
public class Sweden extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Sweden");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Sweden: Du gamla, Du fria");
	private	java.net.URL flagPath = getClass().getResource("sweden.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("sweden_swedish.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("sweden_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Swedish", TitledBorder.CENTER,
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Sweden.wav"));
