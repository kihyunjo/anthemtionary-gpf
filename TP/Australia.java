...
public class Australia extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Australia");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Australia: Advance Australia Fair");
	private	java.net.URL flagPath = getClass().getResource("australia.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("australia_english.png");	
  ...
  //setNationWindow
	...
	{
		Australia mainGui = new Australia();
