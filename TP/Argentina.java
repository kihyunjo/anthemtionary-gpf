...
public class Argentina extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Argentina");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Argentina: Himno Nacional Argentino");
	private	java.net.URL flagPath = getClass().getResource("argentina.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("argentina_spanish.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("argentina_english.png");	
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Argentina.wav"));
	...
	{
		Argentina mainGui = new Argentina();
