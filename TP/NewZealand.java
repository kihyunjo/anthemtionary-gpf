...
public class NewZealand extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("New Zealand");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("New Zealand: God Defend New Zealand");
	private	java.net.URL flagPath = getClass().getResource("newzealand.jpeg");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("newzealand_Māori.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("newzealand_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Māori", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("NewZealand.wav"));
	...
	{
		NewZealand mainGui = new NewZealand();
