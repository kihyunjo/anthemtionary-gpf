...
public class Uzbekistan extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Uzbekistan");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Uzbekistan: Oʻzbekiston Respublikasining Davlat Madhiyasi");
	private	java.net.URL flagPath = getClass().getResource("uzbekistan.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("uzbekistan_uzbek.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("uzbekistan_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Uzbek", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Uzbekistan.wav"));
	...
	{
		Uzbekistan mainGui = new Uzbekistan();
