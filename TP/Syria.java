...
public class Syria extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Syria");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Syria: حُمَاةَ الدِّيَار");
  private	java.net.URL flagPath = getClass().getResource("syria.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("syria_arabic.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("syria_english.png");	
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Syria.wav"));
