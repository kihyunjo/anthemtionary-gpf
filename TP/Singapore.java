...
public class Singapore extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Singapore");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Singapore: Majulah Singapura");
	//private	java.net.URL flagPath = getClass().getResource("iran.gif");		
	private	java.net.URL flagPath = getClass().getResource("singapore.png");			
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("singapore_malay.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("singapore_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Malay", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Singapore.wav"));
	...
	{
		Singapore mainGui = new Singapore();
