...
public class Afghanistan extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Afghanistan");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Afghanistan: ملی سرود");
	private	java.net.URL flagPath = getClass().getResource("afghanistan.gif");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("afghanistan_pashto.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("afghanistan_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Pashto", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Afghanistan.wav"));
	...
	{
		Afghanistan mainGui = new Afghanistan();
