...
public class Iran extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Iran");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Iran: سرود ملی جمهوری اسلامی ایران");
	private	java.net.URL flagPath = getClass().getResource("iran.gif");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("iran_persian.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("iran_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Persian", TitledBorder.CENTER,
