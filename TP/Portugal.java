...
public class Portugal extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Portugal");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Portugal: A Portuguesa");
	private	java.net.URL flagPath = getClass().getResource("portugal.gif");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("portugal_portuguese.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("portugal_english.png");	
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Portugal.wav"));
