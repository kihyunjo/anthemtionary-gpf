...
public class Ethiopia extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Ethiopia");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Ethiopia: Wodefit Gesgeshi, Widd Innat Ityopp'ya");
	private	java.net.URL flagPath = getClass().getResource("ethiopia.gif");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("ethiopia_amharic.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("ethiopia_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Amharic", TitledBorder.CENTER,
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Ethiopia.wav"));
