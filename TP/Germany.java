...
public class Germany extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Germany");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Germany: Das Lied der Deutschen");
	private	java.net.URL flagPath = getClass().getResource("germany.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("germany_german.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("germany_english.png");	
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Germany.wav"));
