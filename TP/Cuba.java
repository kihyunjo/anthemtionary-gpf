...
public class Cuba extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Cuba");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Cuba: El Himno de Bayamo");
	private	java.net.URL flagPath = getClass().getResource("cuba.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("cuba_spanish.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("cuba_english.png");	
