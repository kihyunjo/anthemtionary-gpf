...
public class Mexico extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Mexico");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Mexico: Himno Nacional Mexicano");
	private	java.net.URL flagPath = getClass().getResource("mexico.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("mexico_spanish.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("mexico_english.png");	
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Mexico.wav"));
