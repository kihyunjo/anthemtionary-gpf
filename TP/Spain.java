...
public class Spain extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Spain");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Spain: Marcha Real");
	private	java.net.URL flagPath = getClass().getResource("spain.jpeg");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("spain_spanish.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("spain_english.png");	
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Spain.wav"));
