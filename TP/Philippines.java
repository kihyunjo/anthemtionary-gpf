...
public class Philippines extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Philippines");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Philippines: Lupang Hinirang");
	private	java.net.URL flagPath = getClass().getResource("philippines.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("philippines_filipino.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("philippines_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Filipino", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Philippines.wav"));
	...
	{
		Philippines mainGui = new Philippines();
