...
public class SaudiArabia extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Saudi Arabia");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Saudi Arabia: النشيد الوطني");
	private	java.net.URL flagPath = getClass().getResource("saudiarabia.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("saudiarabia_arabic.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("saudiarabia_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Arabic", TitledBorder.CENTER,
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("SaudiArabia.wav"));
	...
	{
		SaudiArabia mainGui = new SaudiArabia();
