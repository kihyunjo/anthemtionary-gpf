...
public class France extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("France");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("France: La Marseillaise");
	private	java.net.URL flagPath = getClass().getResource("france.jpeg");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("france_french.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("france_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "French", TitledBorder.CENTER,
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("France.wav"));
