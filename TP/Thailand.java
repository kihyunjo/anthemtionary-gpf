...
public class Thailand extends JFrame implements ActionListener
{
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Thailand: เพลงชาติไทย");
	private	java.net.URL flagPath = getClass().getResource("thailand.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("thailand_thai.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("thailand_english.png");	
  ...
  private Border firstBorder2 = new TitledBorder(firstBorder1);
	private Border firstBorder = new TitledBorder(firstBorder2, "Thai", TitledBorder.CENTER,
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Thailand.wav"));
