...
public class Switzerland extends JFrame implements ActionListener
{
	...
	//JFrame
	private JFrame nationFrame = new JFrame("Switzerland");
	...
	//JLabel
	private JLabel titleLabel = new JLabel("Switzerland: Schweizerpsalm");
	private	java.net.URL flagPath = getClass().getResource("switzerland.png");		
	private JLabel flagLabel = new JLabel(new ImageIcon(flagPath));
	private	java.net.URL firstPath = getClass().getResource("switzerland_german.png");	
	private JLabel firstLyrics = new JLabel(new ImageIcon(firstPath));
	private	java.net.URL secondPath = getClass().getResource("switzerland_english.png");	
  ...
  //setNationWindow
	...
	public void setMusic()
	{
		try
		{
			myStream = AudioSystem.getAudioInputStream(
				getClass().getResource("Switzerland.wav"));
	...
	{
		Switzerland mainGui = new Switzerland();
